...
public class RNAddContactModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public static void setServerClientID(String serverClientID) {
      RNAddContactModule.serverClientID = serverClientID;
    }
    ...
    private GoogleSignInOptions buildSignInOptions(ReadableMap config) {
        ...
        String serverClientID = config.hasKey("serverClientID") ? config.getString("serverClientID") : RNAddContactModule.serverClientID;
    ...
    public void signInSilently() {
        if (mGoogleApiClient == null) {
            sendError("RNAddContactError", ERROR_CODE_NULL_API_CLIENT, ERROR_MESSAGE_NULL_API_CLIENT);
            return;
        }
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            if (email == null) {
                ...
                sendEvent("RNAddContactSuccess", params);
            } else {
                this.params = params;
            ...
            sendError("RNAddContactError", code, error);
        }
    }
